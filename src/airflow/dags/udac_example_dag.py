...
# Create a stage table to load data from S3
create_tables_in_redshift = EmptyOperator(
    task_id='Create_tables_in_redshift',
    postgres_conn_id=redshift_conn_id,
    sql='/src/airflow/create_tables.sql',
    dag=dag
)
...
load_user_dimension_table = LoadDimensionOperator(
    ...
    load_sql_query=SqlQueries.user_table_insert,
    redshift_conn_id=redshift_conn_id,
    append_only=False,
    dag=dag
)
